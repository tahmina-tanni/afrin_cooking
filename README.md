# Afrin's Cooking - Recipe Sharing Community

Afrin's Cooking is a modern, responsive web application that allows food enthusiasts to share, discover, and rate recipes from around the world. Built with PHP, MySQL, and vanilla JavaScript, it provides a seamless experience for managing culinary creations.
...
3. **Run Setup Script**
   - Navigate to `http://localhost/Afrin's Cooking/setup.php` in your browser
   - This will:
...
5. **Access the Application**
   - Open `http://localhost/Afrin's Cooking/` in your web browser
...
**Enjoy cooking and sharing with Afrin's Cooking! 🍳👨‍🍳👩‍🍳**
